...
class EntryTest < Minitest::Test
  ...
  def test_from_event_hash
    ...
    entry = HealthDataStandards::Entry.from_event_hash(hash)
  ...
  def test_equality
    entry1 = HealthDataStandards::Entry.new
    entry1.add_code("44556699", "RxNorm")
    entry1.time = 1270598400
    entry2 = HealthDataStandards::Entry.new
    entry2.add_code("44556699", "RxNorm")
    entry2.time = 1270598400
    entry3 = HealthDataStandards::Entry.new
