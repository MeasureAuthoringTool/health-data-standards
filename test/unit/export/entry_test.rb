...
module GreenC32
  class EntryTest < MiniTest::Unit::TestCase
    ...
    def test_vital_signs
      vital_sign = @record.vital_signs.first
      vital_sign.reference_range = "< 500ml"
      ...
      assert_equal vital_sign.reference_range,  vital_sign2.reference_range
    end
    ...
    def test_conditions
      ...
      condition2 = condition_instance.import("/gc32:condition")
    ...
    def test_procedures
      ...
      procedure2 = procedure_instance.import("/gc32:procedure")
