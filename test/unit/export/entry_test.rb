...
module GreenC32
  class EntryTest < Minitest::Test
    ...
    def test_results
      ...
      result.values = [HealthDataStandards::PhysicalQuantityResultValue.new(scalar: 201, units: "mg/dL")]
    ...
    def test_vital_signs
      ...
      vital_sign.values = [HealthDataStandards::PhysicalQuantityResultValue.new(scalar: 130.0, units: "mm[Hg]")]
