module HQMF
  ...
  class DataCriteria
    ...
    FIELDS = {'ABATEMENT_DATETIME' => {title:'Abatement Datetime', coded_entry_method: :end_date, field_type: :timestamp},
              ...
              'COMPONENT' => {title: 'Component', coded_entry_method: :components, code: '1234567', code_system: '2.16.840.1.113883.6.96', field_type: :value},
    ...
    def self.convert_value(json)
      ...
      case type
        ...
        when 'COL'
          value = HQMF::GenericCollection.from_json(json)
        else
