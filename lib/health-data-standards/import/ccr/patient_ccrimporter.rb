  ...
  module Importer
    ...
    class PatientImporterCCR
      ...
      def initialize (check_usable = true)
        @measure_importers = {}
        @section_importers = {}
        @section_importers[:encounters] = SectionImporterCCRSimple.new("//ccr:Encounters/ccr:Encounter",:encounters)
        @section_importers[:procedures] = SectionImporterCCRSimple.new("//ccr:Procedures/ccr:Procedure",:procedures)
        @section_importers[:results] = SectionImporterCCRResult.new("//ccr:Results/ccr:Result",:results)
        @section_importers[:vital_signs] = SectionImporterCCRResult.new("//ccr:VitalSigns/ccr:Result",:vital_signs)
        @section_importers[:medications] = SectionImporterCCRProduct.new("//ccr:Medications/ccr:Medication", :medications)
        @section_importers[:conditions] = SectionImporterCCRSimple.new("//ccr:Problems/ccr:Problem",:conditions)
        @section_importers[:social_history] = SectionImporterCCRSimple.new("//ccr:SocialHistory/ccr:SocialHistoryElement", :social_history)
        @section_importers[:care_goals] = SectionImporterCCRSimple.new("//ccr:Goals/ccr:Goal",:care_goals)
        @section_importers[:medical_equipment] = SectionImporterCCRProduct.new("//ccr:Equpment/ccr:EquipmentElement",:medical_equipment)
        @section_importers[:allergies] = SectionImporterCCRSimple.new("//ccr:Alerts/ccr:Alert",:allergies)
        @section_importers[:immunizations] = SectionImporterCCRProduct.new("//ccr:Immunizations/ccr:Immunization",:immunizations)
        check_usable(false)
      end
      ...
      def get_demographics(patient, doc)
        ...
        patient['gender'] = patientActor.at_xpath('./ccr:Person/ccr:Gender/ccr:Text').content.downcase
