    ...
    module GreenC32
      class MedicationImporter < SectionImporter
        ...
        def import(med_xml)
          ...
          medication = HealthDataStandards::Medication.new
        ...
        def extract_fulfillment_history(med_element)
          med_element.xpath("./gc32:fulfillmentHistory").map do |fh_doc|
            fh = HealthDataStandards::FulfillmentHistory.new(quantityDispensed: extract_quantity(fh_doc, "./gc32:quantityDispensed"))
        ...
        def extract_order_information(med_element)
          med_element.xpath("./gc32:orderInformation").map do |oi_doc|
            oi = HealthDataStandards::OrderInformation.new(fills: extract_node_attribute(oi_doc, :fills, true), orderNumber: extract_node_attribute(oi_doc, :orderNumber))
