    ...
    module GreenC32
      class SectionImporter
        ...
        def extract_value(element, entry)
          ...
          if pq.present?
            entry.values << HealthDataStandards::PhysicalQuantityResultValue.new(pq)
          end
        end
        ...
        def extract_organization(organization_element)
          ...
          organization = org_id ? HealthDataStandards::Organization.find(org_id) : HealthDataStandards::Organization.new
          organization ||= HealthDataStandards::Organization.new
        ...
        def extract_facility(facility_element)
          facility = HealthDataStandards::Facility.new
        ...
        def extract_telecom(telecom_element)
          ...
          telecom = HealthDataStandards::Telecom.new
