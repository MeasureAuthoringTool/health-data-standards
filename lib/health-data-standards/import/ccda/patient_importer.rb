      ...
      class PatientImporter < C32::PatientImporter
        ...
        def initialize(check_usable = true)
          ...
          @section_importers[:procedures] = [generate_importer(ProcedureImporter, nil, '2.16.840.1.113883.3.560.1.57', 'performed'),
                                             generate_importer(ProcedureImporter, "//cda:entry/cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.103' or cda:templateId/@root='2.16.840.1.113883.10.20.22.4.78']", '2.16.840.1.113883.3.560.1.21')] #ProcedureImporter.new#
