      ...
      class ProviderImporter < SectionImporter
        ...
        def extract_providers(doc, patient=nil)
          ...
          performers.map do |performer|
            ...
            HealthDataStandards::ProviderPerformance.new(start_date: provider_perf.delete(:start), end_date: provider_perf.delete(:end), provider: find_or_create_provider(provider_perf, patient))
          end
        end
        ...
        def extract_provider_data(performer, use_dates=true, entity_path="./cda:assignedEntity")
          ...
          entity.xpath("./cda:id").each do |cda_ident|
            ...
            cda_idents.push(HealthDataStandards::CDAIdentifier.new(root: ident_root, extension: ident_extension)) if ident_root.present?
          end
          ...
          provider[:npi] = npi if HealthDataStandards::Provider.valid_npi?(npi)
