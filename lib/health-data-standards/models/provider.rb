module HealthDataStandards
  class Provider
    ...
    embeds_many :cda_identifiers, class_name: "HealthDataStandards::CDAIdentifier", as: :cda_identifiable
    ...
    def npi=(an_npi)
      ...
      if cda_id_npi
        ...
        self.cda_identifiers << HealthDataStandards::CDAIdentifier.new(root: NPI_OID, extension: an_npi)
      end
    end
    ...
    def tin=(a_tin)
      self.cda_identifiers << HealthDataStandards::CDAIdentifier.new(root: TAX_ID_OID, extension: a_tin)
    end
    ...
    def records(effective_date=nil)
      HealthDataStandards::Record.by_provider(self, effective_date)
    end
