module HealthDataStandards
  class Medication < HealthDataStandards::Entry
    ...
    embeds_many :fulfillmentHistory, class_name: 'HealthDataStandards::FulfillmentHistory'
    embeds_many :orderInformation, class_name: 'HealthDataStandards::OrderInformation'
