module HealthDataStandards
  class Entry
    ...
    embeds_one :cda_identifier, class_name: "HealthDataStandards::CDAIdentifier", as: :cda_identifiable
    embeds_many :values, class_name: "HealthDataStandards::ResultValue"
    ...
    def times_to_s(nil_string='UNK')
      if start_time.present? || end_time.present?
        start_string = start_time ? HealthDataStandards::Entry.time_to_s(start_time) : nil_string
        end_string = end_time ? HealthDataStandards::Entry.time_to_s(end_time) : nil_string
    ...
    def set_value(scalar, units=nil)
      pq_value = HealthDataStandards::PhysicalQuantityResultValue.new(scalar: scalar, units: units)
