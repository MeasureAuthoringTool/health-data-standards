module HealthDataStandards
  module Validate
	...
	neutral_ids = doc_neutral_ids - (doc_neutral_ids - bundle_neutral_ids)
	...
	(doc_neutral_ids - neutral_ids).map do |hqmf_set_id|
	...
	previous = ""
	index = 1
	neutral_ids.each do |hqmf_set_id|
	  ...
	  measure_id_entry = doc_measure_ids[(doc.xpath(location_of_set_id(hqmf_set_id,index)) - doc.xpath(first_entry))]
